...
vw_train_cmd = './vw -d /dev/stdin -c -f model --bfgs --passes 30 --cache_file cache -b 22 --loss_function logistic --l2 14 --termination 0.00001'
vw_test_cmd = './vw -d /dev/stdin -t -i model -p /dev/stdout'
